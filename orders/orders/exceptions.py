...
#non_field_errors при невалидированном логине выглядел странно, поэтому здесь эти правки в обработчик исключений
#теперь исключения обернуты в словарь 'errors' при json-ответе
